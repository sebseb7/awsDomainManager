...
vibe-coded this tool with `kwaipilot/kat-coder-pro-v2` for $0.08, which was faster than logging into the AWS console. I only needed to create a single A record.